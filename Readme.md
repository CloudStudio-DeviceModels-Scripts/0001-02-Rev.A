...
# Configuration Script – 0001-02 - Rev. A

This **Configuration** script is designed for the **0001-02** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – 0001-02 Rev. A

Este script de **Configuration** está diseñado para el modelo **0001-02** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
